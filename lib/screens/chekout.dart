...
import 'package:myapplication/model/cartmodel.dart';
import 'package:myapplication/provider/product_provider.dart';
import 'package:myapplication/screens/homepage.dart';
import 'package:myapplication/widgets/checkout_singleproduct.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text("Page Panier", style: TextStyle(color: Colors.black)),
